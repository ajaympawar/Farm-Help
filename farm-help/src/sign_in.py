...
credentials_path = 'D:/FarmHelp/farmer-help/farm-help/assets/setup/farmhelp-b1f81-firebase-adminsdk-ftn53-a17f1584f1.json'
...
class SigninPage(QWidget):
    ...
    def sign_in_UI(self):
        ...
        self.bird_anim.setDuration(5000) # Set the duration of the bird_anim to 1 second
